...
def get_model(model_name: str):
    """Return a scikit-learn model object by name."""
...
def main():
    ...
    asset_summary.to_csv(RESULT_DIR / "ml_sklearn_model_comparison_asset_summary.csv", index=False)
    ...
    portfolio_summary.to_csv(RESULT_DIR / "ml_sklearn_model_comparison_portfolio_summary.csv", index=False)
    ...
    plt.title("Day 25 - sklearn Model Comparison: Robust Assets Portfolio")
    plt.xlabel("Date")
    plt.ylabel("Equity Curve")
    plt.legend()
    plt.tight_layout()
    plt.savefig(CHART_DIR / "sklearn_model_comparison_robust_assets_equity_curves.png", dpi=150)
    plt.close()
    ...
    print("\n==============================")
    print("Asset-Level sklearn Model Comparison")
    print("==============================")
    ...
    print("\n==============================")
    print("Portfolio-Level sklearn Model Comparison")
    print("==============================")
    ...
    print("\nSaved files:")
    print(f"- {RESULT_DIR / 'ml_sklearn_model_comparison_asset_summary.csv'}")
    print(f"- {RESULT_DIR / 'ml_sklearn_model_comparison_portfolio_summary.csv'}")
    print(f"- {CHART_DIR / 'sklearn_model_comparison_robust_assets_equity_curves.png'}")
